                ...
                <td id="m_-7626415423304311386email_content"
                    ...
                    <table border="0" width="100%" cellspacing="0" cellpadding="0"
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="background-color: {{ $mailData['bg_header'] }} ">
                                    <table border="0" width="100%" cellspacing="0" cellpadding="0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="width:100%;text-align:left;height:33px">
                                                                    <img height="33"
                                                                        src="{{ $mailData['url_avatar'] }}"
                                                                        style="border:0"
                                                                        alt="{{ $mailData['nameCompany'] }}"
                                                                                                ...
                                                                                                <td>
                                                                                                    <table
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td>
                                                                                                                    <a href="{{ $mailData['url_website'] }}"
                                                                                                                        style="color:rgb(103, 9, 157);text-decoration:none;display:block;width:370px"
                                                                                                                        target="_blank">
                                                                                                                        <table
                                                                                                                            border="0"
                                                                                                                            width="390"
                                                                                                                                                ...
                                                                                                                                                <font
                                                                                                                                                    ...
                                                                                                                                                    <span
                                                                                                                                                        ...
                                                                                                                                                        <span
                                                                                                                                                            ...
                                                                                                                                                            cập</span>&nbsp;
                                                                                                                                                        <span
                                                                                                                                                            class="il">{{ $mailData['nameCompany'] }}</span></span>
                                                                                                                                                </font>
                                                                                                                                            </center>
                                                                                                                                        </a>
                                                                                                                                    </td>
