                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="width:100%;text-align:left;height:33px">
                                                                    <img height="33"
                                                                        src="{{ $mailAdminContactData['url_avatar'] }}"
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            <tr>
                                                                                                                <td>
                                                                                                                    ...
                                                                                                                    <p
                                                                                                                        style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">
                                                                                                                        Tên:{{ $mailAdminContactData['name'] }}
                                                                                                                    </p>
                                                                                                                    <p
                                                                                                                        style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">
                                                                                                                        Email
                                                                                                                        :
                                                                                                                        {{ $mailAdminContactData['email'] }}
                                                                                                                    </p>
                                                                                                                    <p
                                                                                                                        style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">
                                                                                                                        kinh
                                                                                                                        phí
                                                                                                                        :{{ $mailAdminContactData['budget'] }}
                                                                                                                    </p>
                                                                                                                    <p
                                                                                                                        style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">
                                                                                                                        Số
                                                                                                                        ...
                                                                                                                        :
                                                                                                                        <a
                                                                                                                            href="tel:{{ $mailAdminContactData['phone'] }}">{{ $mailAdminContactData['phone'] }}</a>
                                                                                                                    </p>
                                                                                                                    <p
                                                                                                                        style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">
                                                                                                                        Note:
                                                                                                                        {{ $mailAdminContactData['note'] }}
                                                                                                                    </p>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center">
                                                    ...
                                                    <div style="color:#abadae;font-size:11px;margin:0 auto 5px auto">
                                                        <a target="_blank" href="https://vinawebapp.com">
                                                            @Vinawebapp.com</a>
                                                        <br>
                                                    </div>
                                                    <div style="color:#abadae;font-size:11px;margin:0 auto 5px auto">
